  ...
  onSubmit(): void {
    ...
    this.http.post(this.apiUrl, formData, { headers }).subscribe({
      ...
      error: (err) => {
        ...
        alert('Failed to register Delivery Partner. Please check console.');
      },
    });
  }
